...
class AddEditProfileTest {

    @Rule
    @JvmField
    var mActivityScenarioRule = ActivityScenarioRule(AddEditProfile::class.java)
    ...
    fun addEditProfileTest() {
        ...
        val textInputEditText4 = onView(
            allOf(
                withId(R.id.et_phonenumber),
                childAtPosition(
                    childAtPosition(
                        withId(R.id.layout_phonenumber),
                        0
                    ),
                    0
                )
